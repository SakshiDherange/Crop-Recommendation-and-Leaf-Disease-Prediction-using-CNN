...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#00FFFF", fg="black")
l1.place(x=610, y=50)

# that is for label1 registration

l2 = tk.Label(window, text="Full Name :", width=14, font=("Times new roman", 15), bg="#00FFFF", fg="black")
...
l3 = tk.Label(window, text="Address :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
...
l5 = tk.Label(window, text="E-mail :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
l5.place(x=465, y=250)
t4 = tk.Entry(window, textvar=Email, width=35, font=('', 15))
t4.place(x=700, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
l6.place(x=465, y=300)
t5 = tk.Entry(window, textvar=Phoneno, width=35, font=('', 15))
t5.place(x=700, y=300)
# phone number
l7 = tk.Label(window, text="Gender :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
...
l8 = tk.Label(window, text="Age :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
l8.place(x=465, y=400)
t6 = tk.Entry(window, textvar=age, width=35, font=('', 15))
t6.place(x=700, y=400)

l4 = tk.Label(window, text="User Name :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
l4.place(x=465, y=450)
t3 = tk.Entry(window, textvar=username, width=35, font=('', 15))
t3.place(x=700, y=450)

l9 = tk.Label(window, text="Password :", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
l9.place(x=465, y=500)
t9 = tk.Entry(window, textvar=password, width=35, font=('', 15), show="*")
t9.place(x=700, y=500)

l10 = tk.Label(window, text="Confirm Password:", width=14, font=("Times new roman", 15, "bold"), bg="#00FFFF", fg="black")
